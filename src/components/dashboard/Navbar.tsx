      ...
      <div className="px-3 py-3 lg:px-5 lg:pl-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center justify-start">
            ...
            >
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRFmE3w-X73REog4VStl6z--ALd5ZoCszm0oA&s"
                className="h-10 mr-2 rounded-lg bg-gray-600 hover:bg-gray-400 p-0.5"
                alt="Windster Logo"
              />
            </a>
          ...
          <div className="flex items-center">
            ...
            >
              ...
              Agricultores de los llanos | Bienvenido {username}
            </a>
          </div>
        </div>
      </div>
